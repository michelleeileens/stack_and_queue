...
public class MyQueueTestStudent {
	...
	public void testDequeueStudent() {
		try {
			assertEquals(15.0, doubleQ.dequeue(),.0);
			assertEquals(55.0, doubleQ.dequeue(),.0);
			assertEquals(150.0, doubleQ.dequeue(),.0);
	...
	public void testEnqueueStudent() {
		try {
			...
			assertEquals(true, doubleQ.enqueue(45.0));
			assertEquals(4, doubleQ.size());
			assertEquals(true, doubleQ.enqueue(25.0));
	...
	public void testToStringStudent() throws QueueOverflowException {
		...
		doubleQ.enqueue(35.0);
		assertEquals(doubleQ.toString(),"15.055.0150.035.0");
	}
